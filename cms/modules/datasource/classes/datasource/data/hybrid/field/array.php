...
class DataSource_Data_Hybrid_Field_Array extends DataSource_Data_Hybrid_Field_Document {
	...
	public function fetch_value($doc) 
	{
		...
		$doc->fields[$this->name] = DataSource_Data_Hybrid_Field_Utils::get_document_headers($this->type, $this->from_ds, $ids);
	}
