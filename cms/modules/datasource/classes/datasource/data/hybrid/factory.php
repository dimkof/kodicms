...
class DataSource_Data_Hybrid_Factory {
	...
	public function create($key, $name, $description, $parent) 
	{
		...
		$ds = new DataSource_Data_Hybrid_Section($key, $parent);
		...
		if(self::create_table($ds->ds_id)) 
		{
			if(self::create_folder($ds->ds_id)) 
			{
	 ...
	 * 
	 * @param array $ids
	 * @return \DataSource_Data_Hybrid_Factory
	 */
